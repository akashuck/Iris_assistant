                ...
                if (responseBody != null) {
                    try {
                        ...
                        runOnUiThread {
                            ...
                            // Note: In a real app, we'd trigger the AccessibilityService here.
                            // Since AccessibilityService is a separate service, we can't call it directly.
                            // We would typically use a Broadcast or a shared state.
                        }
                    } catch (e: Exception) {
